...
export default function IdealPayment() {
  ...
  const copy = async (value: string, key: string) => {
    try {
      ...
      // Clipboard unavailable; page remains usable.
    }
  };

  const goToOrderSuccess = () => {
    navigate(
      `/checkout/success?order=${encodeURIComponent(order)}&tracking=${encodeURIComponent(tracking)}`
    );
  };
    ...
    return (
      <div className="ideal-root ideal-loading">
        <div className="loading-center">
          ...
          />
          <div className="loading-dots" aria-label="Laden">
            <i />
            <i />
            <i />
          </div>
    ...
    return (
      <div className={`ideal-root success-root ${dark ? 'dark' : ''}`}>
        ...
        <main className="success-content">
          ...
          <button className="primary-button" onClick={goToOrderSuccess}>
            Verder
          </button>
      ...
      <div className={`ideal-root ${dark ? 'dark' : ''}`}>
        ...
        <main className="center-main">
          <section className="payment-card">
            ...
            <p>
              Maak het bedrag over met onderstaande betaalgegevens.
            </p>
      ...
      <div className={`ideal-root ${dark ? 'dark' : ''}`}>
        ...
        <main className="center-main">
          <section className="payment-card">
            ...
            <p>
              De testomgeving kan geen echte banktransactie uitvoeren.
              Je kunt het bedrag handmatig overmaken.
            </p>
  ...
  return (
    <style>{`
      ...
      .bank-main{
        ...
        padding:clamp(42px,7vh,72px) 20px 48px;
      }
      ...
      .bank-row:hover{
        border-color:#555;
        box-shadow:0 4px 16px rgba(35,35,35,.08);
      ...
      .payment-card{
        ...
        border-radius:20px;
        box-shadow:0 18px 55px rgba(30,55,65,.10);
